...
const Home = () => {
  ...
  // Safely handle potential null values from localStorage
  const userId = localStorage.getItem("userId")?.toString() || '';  // Provide default value if null
  const userName = localStorage.getItem("userName")?.toString() || '';  // Provide default value if null
